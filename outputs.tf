...
output "route_tables" {
  value = {
    public  = aws_route_table.dimo-solar-rtb-public-test-apse1.name
    private1 = aws_route_table.dimo-solar-rtb-private1-apse1a.name
    private2 = aws_route_table.dimo-solar-rtb-private2-apse1b.name
  }
}
...
output "routes" {
  value = {
    public_routes = aws_route_table.dimo-solar-rtb-public-test-apse1.route[*]
...
output "security_groups" {
  value = {
    ec2     = aws_security_group.dimo-solar-ec2-sg-test-apse1.name
    rds     = aws_security_group.dimo-solar-rds-sg-test-apse1.name
    alb     = aws_security_group.dimo-solar-alb-sg-test-apse1.name
    vpce_s3 = aws_security_group.dimo-solar-vpce-s3-sg-test-apse1.name
    lambda  = aws_security_group.dimo-solar-lambda-sg-test-apse1.name
  }
}
...
output "ingress_rules" {
  value = {
    ...
    allow_tcp_3000_from_alb = {
      security_group_id = aws_vpc_security_group_ingress_rule.allow-tcp-from-3000.security_group_id
      from_port         = aws_vpc_security_group_ingress_rule.allow-tcp-from-3000.from_port
      to_port           = aws_vpc_security_group_ingress_rule.allow-tcp-from-3000.to_port
      referenced_sg     = aws_vpc_security_group_ingress_rule.allow-tcp-from-3000.referenced_security_group_id
    }
