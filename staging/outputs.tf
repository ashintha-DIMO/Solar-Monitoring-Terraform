...
output "route_tables" {
  value = {
    public  = aws_route_table.dimo-solar-rtb-public-staging-apse1.id
...
output "routes" {
  value = {
    public_routes = aws_route_table.dimo-solar-rtb-public-staging-apse1.route[*]
...
output "security_groups" {
  value = {
    ec2     = aws_security_group.dimo-solar-ec2-sg-staging-apse1.name
    rds     = aws_security_group.dimo-solar-rds-sg-staging-apse1.name
    alb     = aws_security_group.dimo-solar-alb-sg-staging-apse1.name
    vpce_s3 = aws_security_group.dimo-solar-vpce-sg-staging-apse1.name
    lambda  = aws_security_group.dimo-solar-lambda-sg-staging-apse1.name
  }
}
